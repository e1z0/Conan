...
RUN /usr/bin/env UNATTENDED=1 osxcross-macports fake-install py313 py313-packaging \
    xorg xrender

# Install Qt 5.15 and dependencies
RUN /usr/bin/env UNATTENDED=1 osxcross-macports --arm64 install qt5-qtbase
